...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "odl-sal-dom-rpc-remote-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:md:sal:remote:rpc";
    private final String revision = "2013-10-28";
    private final String resourcePath = "/META-INF/yang/odl-sal-dom-rpc-remote-cfg.yang";
