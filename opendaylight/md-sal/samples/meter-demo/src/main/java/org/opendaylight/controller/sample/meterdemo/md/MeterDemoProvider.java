 ...
 */
public class MeterDemoProvider extends AbstractBindingAwareConsumer
                              implements AutoCloseable {

  private final static Logger _logger = LoggerFactory.getLogger(MeterDemoProvider.class);
  
  OpenflowpluginMeterTestCommandConsumer cmdMeterConsumer;
  OpenflowpluginTestCommandConsumer cmdFlowConsumer;
/*
...
*/
    ...
    cmdMeterConsumer.onSessionInitiated(consumerContext);
    cmdFlowConsumer.onSessionInitiated(consumerContext);
...
*/
  ...
  protected void startImpl(BundleContext context) {
      cmdMeterConsumer = new OpenflowpluginMeterTestCommandConsumer(context);
      cmdFlowConsumer = new OpenflowpluginTestCommandConsumer(context);
    }
}
