...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-port-statistics";
    private final String namespace = "urn:opendaylight:port:statistics";
    private final String revision = "2013-12-14";
    private final String resourcePath = "/META-INF/yang/opendaylight-port-statistics.yang";
