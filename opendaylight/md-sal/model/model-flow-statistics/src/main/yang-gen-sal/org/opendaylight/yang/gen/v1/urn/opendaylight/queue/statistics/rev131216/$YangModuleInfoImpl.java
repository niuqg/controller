...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-queue-statistics";
    private final String namespace = "urn:opendaylight:queue:statistics";
    private final String revision = "2013-12-16";
    private final String resourcePath = "/META-INF/yang/opendaylight-queue-statistics.yang";
