...
public class GetFlowStatisticsFromFlowTableInputBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>> augmentation = new HashMap<>();

    public GetFlowStatisticsFromFlowTableInputBuilder() {
    } 
    
    public GetFlowStatisticsFromFlowTableInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>> E getAugmentation(Class<E> augmentationType) {
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public GetFlowStatisticsFromFlowTableInputBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public GetFlowStatisticsFromFlowTableInputBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public GetFlowStatisticsFromFlowTableInput build() {
        return new GetFlowStatisticsFromFlowTableInputImpl(this);
    }

    private static final class GetFlowStatisticsFromFlowTableInputImpl implements GetFlowStatisticsFromFlowTableInput {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>> augmentation;

        private GetFlowStatisticsFromFlowTableInputImpl(GetFlowStatisticsFromFlowTableInputBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetFlowStatisticsFromFlowTableInput>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            GetFlowStatisticsFromFlowTableInputImpl other = (GetFlowStatisticsFromFlowTableInputImpl) obj;
            if (_barrier == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("GetFlowStatisticsFromFlowTableInput [");
            boolean first = true;
