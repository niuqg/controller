...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-group-statistics";
    private final String namespace = "urn:opendaylight:group:statistics";
    private final String revision = "2013-11-11";
    private final String resourcePath = "/META-INF/yang/opendaylight-group-statistics.yang";
