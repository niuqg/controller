...
public class FlowStatisticsBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics>> augmentation = new HashMap<>();

    public FlowStatisticsBuilder() {
    } 
    
    public FlowStatisticsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.model.statistics.types.rev130925.GenericStatistics arg) {
        this._byteCount = arg.getByteCount();
        this._packetCount = arg.getPacketCount();
        this._duration = arg.getDuration();
    }
    
    public FlowStatisticsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.model.statistics.types.rev130925.Duration arg) {
        this._duration = arg.getDuration();
    }
    
    public FlowStatisticsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
    ...
    public FlowStatisticsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics>> E getAugmentation(Class<E> augmentationType) {
    ...
    public FlowStatisticsBuilder setByteCount(Counter64 value) {
    
        this._byteCount = value;
        return this;
    }
    
    public FlowStatisticsBuilder setPacketCount(Counter64 value) {
    
        this._packetCount = value;
        return this;
    }
    
    public FlowStatisticsBuilder setDuration(Duration value) {
    
        this._duration = value;
        return this;
    }
    
    public FlowStatisticsBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public FlowStatisticsBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public FlowStatisticsBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public FlowStatisticsBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public FlowStatisticsBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public FlowStatisticsBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public FlowStatisticsBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public FlowStatisticsBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public FlowStatisticsBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public FlowStatisticsBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public FlowStatisticsBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public FlowStatisticsBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public FlowStatisticsBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public FlowStatisticsBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public FlowStatisticsBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public FlowStatisticsBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public FlowStatisticsBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public FlowStatisticsBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public FlowStatistics build() {
        return new FlowStatisticsImpl(this);
    }

    private static final class FlowStatisticsImpl implements FlowStatistics {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.flow.statistics.FlowStatistics>> augmentation;

        private FlowStatisticsImpl(FlowStatisticsBuilder builder) {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            FlowStatisticsImpl other = (FlowStatisticsImpl) obj;
            if (_byteCount == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("FlowStatistics [");
            boolean first = true;
