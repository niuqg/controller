...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-flow-statistics";
    private final String namespace = "urn:opendaylight:flow:statistics";
    private final String revision = "2013-08-19";
    private final String resourcePath = "/META-INF/yang/opendaylight-flow-statistics.yang";
