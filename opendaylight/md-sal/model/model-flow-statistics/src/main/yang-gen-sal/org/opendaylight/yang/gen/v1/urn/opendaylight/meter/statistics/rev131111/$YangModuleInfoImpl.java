...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-meter-statistics";
    private final String namespace = "urn:opendaylight:meter:statistics";
    private final String revision = "2013-11-11";
    private final String resourcePath = "/META-INF/yang/opendaylight-meter-statistics.yang";
