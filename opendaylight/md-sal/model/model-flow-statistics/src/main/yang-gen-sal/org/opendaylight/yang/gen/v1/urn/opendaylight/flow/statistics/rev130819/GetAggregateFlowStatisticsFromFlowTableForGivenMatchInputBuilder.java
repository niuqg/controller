...
public class GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>> augmentation = new HashMap<>();

    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder() {
    } 
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes, org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef, org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>> E getAugmentation(Class<E> augmentationType) {
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput build() {
        return new GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputImpl(this);
    }

    private static final class GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputImpl implements GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>> augmentation;

        private GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputImpl(GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputImpl other = (GetAggregateFlowStatisticsFromFlowTableForGivenMatchInputImpl) obj;
            if (_barrier == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("GetAggregateFlowStatisticsFromFlowTableForGivenMatchInput [");
            boolean first = true;
