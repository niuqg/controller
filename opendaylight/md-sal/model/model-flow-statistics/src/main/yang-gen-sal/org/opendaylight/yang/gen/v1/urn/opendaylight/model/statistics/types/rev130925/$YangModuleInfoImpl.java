...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-statistics-types";
    private final String namespace = "urn:opendaylight:model:statistics:types";
    private final String revision = "2013-09-25";
    private final String resourcePath = "/META-INF/yang/opendaylight-statistics-types.yang";
