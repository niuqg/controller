...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "flow-capable-transaction";
    private final String namespace = "urn:opendaylight:flow:transaction";
    private final String revision = "2013-11-03";
    private final String resourcePath = "/META-INF/yang/flow-capable-transaction.yang";
