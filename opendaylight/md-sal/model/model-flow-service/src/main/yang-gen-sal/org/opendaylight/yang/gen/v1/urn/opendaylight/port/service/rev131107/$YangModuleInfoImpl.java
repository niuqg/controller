...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-port";
    private final String namespace = "urn:opendaylight:port:service";
    private final String revision = "2013-11-07";
    private final String resourcePath = "/META-INF/yang/sal-port.yang";
