...
public interface ExperimenterErrorNotification
    extends
    ChildOf<DataObject>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.ExperimenterErrorNotification>,
    ErrorMessage,
    NodeErrorReference,
    TransactionAware,
    ...
    Notification
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:node:error:service","2014-04-10","experimenter-error-notification")
    ;
