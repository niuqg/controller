...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-meter";
    private final String namespace = "urn:opendaylight:meter:service";
    private final String revision = "2013-09-18";
    private final String resourcePath = "/META-INF/yang/sal-meter.yang";
