...
public class RemoveGroupInputBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>> augmentation = new HashMap<>();

    public RemoveGroupInputBuilder() {
    } 
    
    
    public RemoveGroupInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.Group arg) {
    ...
    public RemoveGroupInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
        this._node = arg.getNode();
    }
    
    public RemoveGroupInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (!isValidArg) {
            throw new IllegalArgumentException(
              "expected one of: [org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.Group, org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef, org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata] \n" +
              "but was: " + arg
            );
        }
    }
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>> E getAugmentation(Class<E> augmentationType) {
    ...
    public RemoveGroupInputBuilder setGroupRef(GroupRef value) {
    
        this._groupRef = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setBuckets(Buckets value) {
    
        this._buckets = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setGroupId(GroupId value) {
    
        this._groupId = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setGroupName(String value) {
    
        this._groupName = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setGroupType(GroupTypes value) {
    
        this._groupType = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public RemoveGroupInputBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public RemoveGroupInputBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public RemoveGroupInput build() {
        return new RemoveGroupInputImpl(this);
    }

    private static final class RemoveGroupInputImpl implements RemoveGroupInput {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>> augmentation;

        private RemoveGroupInputImpl(RemoveGroupInputBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.RemoveGroupInput>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            RemoveGroupInputImpl other = (RemoveGroupInputImpl) obj;
            if (_groupRef == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("RemoveGroupInput [");
            boolean first = true;
