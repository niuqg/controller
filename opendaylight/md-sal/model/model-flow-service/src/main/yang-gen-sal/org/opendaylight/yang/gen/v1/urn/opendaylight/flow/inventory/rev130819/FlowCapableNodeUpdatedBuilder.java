...
public class FlowCapableNodeUpdatedBuilder {
    ...
    public FlowCapableNodeUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowNode arg) {
    ...
    public FlowCapableNodeUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.Tables arg) {
        this._table = arg.getTable();
    }
    
    public FlowCapableNodeUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.Meters arg) {
        this._meter = arg.getMeter();
    }
    
    public FlowCapableNodeUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.Groups arg) {
        this._group = arg.getGroup();
    }
    ...
    */
    ...
    public FlowCapableNodeUpdatedBuilder setTable(List<Table> value) {
    
        this._table = value;
        return this;
    }
    
    public FlowCapableNodeUpdatedBuilder setMeter(List<Meter> value) {
    
        this._meter = value;
        return this;
    }
    
    public FlowCapableNodeUpdatedBuilder setGroup(List<Group> value) {
    ...
    public FlowCapableNodeUpdated build() {
        return new FlowCapableNodeUpdatedImpl(this);
    }

    private static final class FlowCapableNodeUpdatedImpl implements FlowCapableNodeUpdated {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNodeUpdated> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNodeUpdated.class;
        }
        ...
        private FlowCapableNodeUpdatedImpl(FlowCapableNodeUpdatedBuilder builder) {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            FlowCapableNodeUpdatedImpl other = (FlowCapableNodeUpdatedImpl) obj;
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("FlowCapableNodeUpdated [");
            boolean first = true;
