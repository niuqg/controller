...
public class OriginalFlowBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>> augmentation = new HashMap<>();

    public OriginalFlowBuilder() {
    } 
    
    public OriginalFlowBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
    ...
    public OriginalFlowBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>> E getAugmentation(Class<E> augmentationType) {
    ...
    public OriginalFlowBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public OriginalFlowBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public OriginalFlowBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public OriginalFlowBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public OriginalFlowBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public OriginalFlowBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public OriginalFlowBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public OriginalFlowBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public OriginalFlowBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public OriginalFlowBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public OriginalFlowBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public OriginalFlowBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public OriginalFlowBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public OriginalFlowBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public OriginalFlowBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public OriginalFlowBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public OriginalFlowBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public OriginalFlowBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public OriginalFlow build() {
        return new OriginalFlowImpl(this);
    }

    private static final class OriginalFlowImpl implements OriginalFlow {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>> augmentation;

        private OriginalFlowImpl(OriginalFlowBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.flow.update.OriginalFlow>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            OriginalFlowImpl other = (OriginalFlowImpl) obj;
            if (_barrier == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("OriginalFlow [");
            boolean first = true;
