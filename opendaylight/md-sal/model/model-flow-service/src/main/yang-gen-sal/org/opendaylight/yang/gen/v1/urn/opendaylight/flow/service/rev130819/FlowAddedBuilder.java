...
public class FlowAddedBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>> augmentation = new HashMap<>();

    public FlowAddedBuilder() {
    } 
    
    public FlowAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeFlow arg) {
    ...
    public FlowAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
        this._barrier = arg.isBarrier();
        this._bufferId = arg.getBufferId();
        this._containerName = arg.getContainerName();
        this._cookieMask = arg.getCookieMask();
    ...
    public FlowAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    public FlowAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
        this._node = arg.getNode();
    }
    
    public FlowAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
        this._transactionId = arg.getTransactionId();
    }
    
    public FlowAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>> E getAugmentation(Class<E> augmentationType) {
    ...
    public FlowAddedBuilder setFlowRef(FlowRef value) {
    
        this._flowRef = value;
        return this;
    }
    
    public FlowAddedBuilder setFlowTable(FlowTableRef value) {
    
        this._flowTable = value;
        return this;
    }
    
    public FlowAddedBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public FlowAddedBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public FlowAddedBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public FlowAddedBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public FlowAddedBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public FlowAddedBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public FlowAddedBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public FlowAddedBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public FlowAddedBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public FlowAddedBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public FlowAddedBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public FlowAddedBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public FlowAddedBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public FlowAddedBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public FlowAddedBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public FlowAddedBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public FlowAddedBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public FlowAddedBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public FlowAddedBuilder setTransactionId(TransactionId value) {
    
        this._transactionId = value;
        return this;
    }
    
    public FlowAddedBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public FlowAddedBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public FlowAdded build() {
        return new FlowAddedImpl(this);
    }

    private static final class FlowAddedImpl implements FlowAdded {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>> augmentation;

        private FlowAddedImpl(FlowAddedBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.FlowAdded>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("FlowAdded [");
            boolean first = true;
