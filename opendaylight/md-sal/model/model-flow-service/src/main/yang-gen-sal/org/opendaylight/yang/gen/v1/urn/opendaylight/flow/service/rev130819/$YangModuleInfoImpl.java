...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-flow";
    private final String namespace = "urn:opendaylight:flow:service";
    private final String revision = "2013-08-19";
    private final String resourcePath = "/META-INF/yang/sal-flow.yang";
