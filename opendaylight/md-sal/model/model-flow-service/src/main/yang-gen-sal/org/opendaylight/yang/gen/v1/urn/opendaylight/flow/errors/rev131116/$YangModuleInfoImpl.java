...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "flow-errors";
    private final String namespace = "urn:opendaylight:flow:errors";
    private final String revision = "2013-11-16";
    private final String resourcePath = "/META-INF/yang/flow-errors.yang";
