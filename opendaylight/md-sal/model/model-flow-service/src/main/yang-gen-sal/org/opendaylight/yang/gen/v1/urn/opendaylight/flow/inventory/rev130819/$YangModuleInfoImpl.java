...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "flow-node-inventory";
    private final String namespace = "urn:opendaylight:flow:inventory";
    private final String revision = "2013-08-19";
    private final String resourcePath = "/META-INF/yang/flow-node-inventory.yang";
