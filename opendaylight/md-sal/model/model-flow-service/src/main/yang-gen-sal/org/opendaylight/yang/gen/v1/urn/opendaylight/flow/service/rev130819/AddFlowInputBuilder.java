...
public class AddFlowInputBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>> augmentation = new HashMap<>();

    public AddFlowInputBuilder() {
    } 
    
    public AddFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeFlow arg) {
    ...
    public AddFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
        this._barrier = arg.isBarrier();
        this._bufferId = arg.getBufferId();
        this._containerName = arg.getContainerName();
        this._cookieMask = arg.getCookieMask();
    ...
    public AddFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    public AddFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
        this._node = arg.getNode();
    }
    
    public AddFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>> E getAugmentation(Class<E> augmentationType) {
    ...
    public AddFlowInputBuilder setFlowRef(FlowRef value) {
    
        this._flowRef = value;
        return this;
    }
    
    public AddFlowInputBuilder setFlowTable(FlowTableRef value) {
    
        this._flowTable = value;
        return this;
    }
    
    public AddFlowInputBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public AddFlowInputBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public AddFlowInputBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public AddFlowInputBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public AddFlowInputBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public AddFlowInputBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public AddFlowInputBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public AddFlowInputBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public AddFlowInputBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public AddFlowInputBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public AddFlowInputBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public AddFlowInputBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public AddFlowInputBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public AddFlowInputBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public AddFlowInputBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public AddFlowInputBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public AddFlowInputBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public AddFlowInputBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public AddFlowInputBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public AddFlowInputBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput> augmentation) {
    ...
    private static final class AddFlowInputImpl implements AddFlowInput {
        ...
        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>> augmentation;

        private AddFlowInputImpl(AddFlowInputBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.AddFlowInput>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            AddFlowInputImpl other = (AddFlowInputImpl) obj;
            if (_flowRef == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("AddFlowInput [");
            boolean first = true;
