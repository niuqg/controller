...
public class PortModErrorNotificationBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>> augmentation = new HashMap<>();

    public PortModErrorNotificationBuilder() {
    } 
    
    public PortModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.errors.rev131116.ErrorMessage arg) {
        this._code = arg.getCode();
        this._data = arg.getData();
        this._type = arg.getType();
    }
    
    public PortModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeErrorReference arg) {
        this._objectReference = arg.getObjectReference();
    }
    
    public PortModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
        this._transactionId = arg.getTransactionId();
    }
    
    public PortModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.BaseNodeErrorNotification arg) {
        this._node = arg.getNode();
    }
    
    public PortModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>> E getAugmentation(Class<E> augmentationType) {
    ...
    public PortModErrorNotificationBuilder setCode(Integer value) {
        if (value != null) {
    ...
    public PortModErrorNotificationBuilder setData(String value) {
    
        this._data = value;
        return this;
    }
    
    public PortModErrorNotificationBuilder setType(ErrorType value) {
    
        this._type = value;
        return this;
    }
    
    public PortModErrorNotificationBuilder setObjectReference(ObjectReference value) {
    
        this._objectReference = value;
        return this;
    }
    
    public PortModErrorNotificationBuilder setTransactionId(TransactionId value) {
    
        this._transactionId = value;
        return this;
    }
    
    public PortModErrorNotificationBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public PortModErrorNotificationBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public PortModErrorNotificationBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public PortModErrorNotification build() {
        return new PortModErrorNotificationImpl(this);
    }

    private static final class PortModErrorNotificationImpl implements PortModErrorNotification {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>> augmentation;

        private PortModErrorNotificationImpl(PortModErrorNotificationBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.PortModErrorNotification>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            PortModErrorNotificationImpl other = (PortModErrorNotificationImpl) obj;
            if (_code == null) {
                if (other._code != null) {
                    return false;
                }
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("PortModErrorNotification [");
            boolean first = true;
