...
public class FlowModErrorNotificationBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>> augmentation = new HashMap<>();

    public FlowModErrorNotificationBuilder() {
    } 
    
    public FlowModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.errors.rev131116.ErrorMessage arg) {
        this._code = arg.getCode();
        this._data = arg.getData();
        this._type = arg.getType();
    }
    
    public FlowModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeErrorReference arg) {
        this._objectReference = arg.getObjectReference();
    }
    
    public FlowModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
        this._transactionId = arg.getTransactionId();
    }
    
    public FlowModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.BaseNodeErrorNotification arg) {
        this._node = arg.getNode();
    }
    
    public FlowModErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>> E getAugmentation(Class<E> augmentationType) {
    ...
    public FlowModErrorNotificationBuilder setCode(Integer value) {
        if (value != null) {
    ...
    public FlowModErrorNotificationBuilder setData(String value) {
    
        this._data = value;
        return this;
    }
    
    public FlowModErrorNotificationBuilder setType(ErrorType value) {
    
        this._type = value;
        return this;
    }
    
    public FlowModErrorNotificationBuilder setObjectReference(ObjectReference value) {
    
        this._objectReference = value;
        return this;
    }
    
    public FlowModErrorNotificationBuilder setTransactionId(TransactionId value) {
    
        this._transactionId = value;
        return this;
    }
    
    public FlowModErrorNotificationBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public FlowModErrorNotificationBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public FlowModErrorNotificationBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public FlowModErrorNotification build() {
        return new FlowModErrorNotificationImpl(this);
    }

    private static final class FlowModErrorNotificationImpl implements FlowModErrorNotification {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>> augmentation;

        private FlowModErrorNotificationImpl(FlowModErrorNotificationBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.FlowModErrorNotification>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            FlowModErrorNotificationImpl other = (FlowModErrorNotificationImpl) obj;
            if (_code == null) {
                if (other._code != null) {
                    return false;
                }
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("FlowModErrorNotification [");
            boolean first = true;
