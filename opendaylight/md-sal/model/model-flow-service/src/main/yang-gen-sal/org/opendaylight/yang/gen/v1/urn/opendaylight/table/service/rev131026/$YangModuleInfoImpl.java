...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-table";
    private final String namespace = "urn:opendaylight:table:service";
    private final String revision = "2013-10-26";
    private final String resourcePath = "/META-INF/yang/sal-table.yang";
