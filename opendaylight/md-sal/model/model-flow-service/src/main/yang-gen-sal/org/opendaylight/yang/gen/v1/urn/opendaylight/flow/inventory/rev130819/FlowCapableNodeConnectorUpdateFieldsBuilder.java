...
public class FlowCapableNodeConnectorUpdateFieldsBuilder {
    ...
    public FlowCapableNodeConnectorUpdateFieldsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.FlowCapablePort arg) {
    ...
    public FlowCapableNodeConnectorUpdateFieldsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.CommonPort arg) {
        this._advertisedFeatures = arg.getAdvertisedFeatures();
        this._configuration = arg.getConfiguration();
        this._hardwareAddress = arg.getHardwareAddress();
        this._portNumber = arg.getPortNumber();
    ...
    public FlowCapableNodeConnectorUpdateFieldsBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.Queues arg) {
        this._queue = arg.getQueue();
    }
    ...
    */
    ...
    public FlowCapableNodeConnectorUpdateFieldsBuilder setPortNumber(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    private static final class FlowCapableNodeConnectorUpdateFieldsImpl implements FlowCapableNodeConnectorUpdateFields {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNodeConnectorUpdateFields> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNodeConnectorUpdateFields.class;
        }
        ...
        private FlowCapableNodeConnectorUpdateFieldsImpl(FlowCapableNodeConnectorUpdateFieldsBuilder builder) {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            FlowCapableNodeConnectorUpdateFieldsImpl other = (FlowCapableNodeConnectorUpdateFieldsImpl) obj;
