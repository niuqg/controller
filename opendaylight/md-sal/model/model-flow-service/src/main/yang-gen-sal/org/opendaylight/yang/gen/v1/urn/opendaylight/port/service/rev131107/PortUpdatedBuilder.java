...
public class PortUpdatedBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>> augmentation = new HashMap<>();

    public PortUpdatedBuilder() {
    } 
    
    public PortUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdate arg) {
        this._originalPort = arg.getOriginalPort();
        this._updatedPort = arg.getUpdatedPort();
        this._node = arg.getNode();
    }
    
    public PortUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
        this._node = arg.getNode();
    }
    
    public PortUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>> E getAugmentation(Class<E> augmentationType) {
    ...
    public PortUpdatedBuilder setOriginalPort(OriginalPort value) {
    
        this._originalPort = value;
        return this;
    }
    
    public PortUpdatedBuilder setUpdatedPort(UpdatedPort value) {
    
        this._updatedPort = value;
        return this;
    }
    
    public PortUpdatedBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public PortUpdatedBuilder setTransactionId(TransactionId value) {
    
        this._transactionId = value;
        return this;
    }
    
    public PortUpdatedBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public PortUpdated build() {
        return new PortUpdatedImpl(this);
    }

    private static final class PortUpdatedImpl implements PortUpdated {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>> augmentation;

        private PortUpdatedImpl(PortUpdatedBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.PortUpdated>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            PortUpdatedImpl other = (PortUpdatedImpl) obj;
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("PortUpdated [");
            boolean first = true;
