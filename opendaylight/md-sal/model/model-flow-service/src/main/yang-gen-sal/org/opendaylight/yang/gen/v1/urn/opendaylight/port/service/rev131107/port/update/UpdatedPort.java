...
public interface UpdatedPort
    extends
    ChildOf<PortUpdate>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.port.service.rev131107.port.update.UpdatedPort>,
    PortMod
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:port:service","2013-11-07","updated-port")
    ;
