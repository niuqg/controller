...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-queue";
    private final String namespace = "urn:opendaylight:queue:service";
    private final String revision = "2013-11-07";
    private final String resourcePath = "/META-INF/yang/sal-queue.yang";
