...
public class MatchBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>> augmentation = new HashMap<>();
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>> E getAugmentation(Class<E> augmentationType) {
    ...
    public MatchBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match> augmentation) {
    ...
    private static final class MatchImpl implements Match {
        ...
        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>> augmentation;
        ...
        private MatchImpl(MatchBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.received.Match>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
