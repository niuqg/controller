...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "packet-processing";
    private final String namespace = "urn:opendaylight:packet:service";
    private final String revision = "2013-07-09";
    private final String resourcePath = "/META-INF/yang/packet-processing.yang";
