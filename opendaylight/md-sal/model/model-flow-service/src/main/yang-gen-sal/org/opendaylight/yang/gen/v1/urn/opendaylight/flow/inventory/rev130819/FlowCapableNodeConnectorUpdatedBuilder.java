...
public class FlowCapableNodeConnectorUpdatedBuilder {
    ...
    public FlowCapableNodeConnectorUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.FlowCapablePort arg) {
    ...
    public FlowCapableNodeConnectorUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.CommonPort arg) {
        this._advertisedFeatures = arg.getAdvertisedFeatures();
        this._configuration = arg.getConfiguration();
        this._hardwareAddress = arg.getHardwareAddress();
        this._portNumber = arg.getPortNumber();
    ...
    public FlowCapableNodeConnectorUpdatedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.Queues arg) {
        this._queue = arg.getQueue();
    }
    ...
    */
    ...
    public FlowCapableNodeConnectorUpdatedBuilder setHardwareAddress(MacAddress value) {
    
        this._hardwareAddress = value;
        return this;
    }
    
    public FlowCapableNodeConnectorUpdatedBuilder setPortNumber(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public FlowCapableNodeConnectorUpdatedBuilder setQueue(List<Queue> value) {
    ...
    private static final class FlowCapableNodeConnectorUpdatedImpl implements FlowCapableNodeConnectorUpdated {
        ...
        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNodeConnectorUpdated> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.FlowCapableNodeConnectorUpdated.class;
        }
        ...
        private FlowCapableNodeConnectorUpdatedImpl(FlowCapableNodeConnectorUpdatedBuilder builder) {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            FlowCapableNodeConnectorUpdatedImpl other = (FlowCapableNodeConnectorUpdatedImpl) obj;
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("FlowCapableNodeConnectorUpdated [");
            boolean first = true;
