...
public class ConnectionCookie
 {
    ...
    public ConnectionCookie(Long _value) {
        if (_value != null) {
     ...
     */
    public ConnectionCookie(ConnectionCookie source) {
        this._value = source._value;
    }
    
    public static ConnectionCookie getDefaultInstance(String defaultValue) {
        return new ConnectionCookie(new Long(defaultValue));
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ConnectionCookie other = (ConnectionCookie) obj;
        if (_value == null) {
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("ConnectionCookie [");
        boolean first = true;
