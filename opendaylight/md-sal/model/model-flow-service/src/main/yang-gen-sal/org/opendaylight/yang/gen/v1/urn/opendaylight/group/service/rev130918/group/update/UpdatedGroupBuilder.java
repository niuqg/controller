...
public class UpdatedGroupBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>> augmentation = new HashMap<>();

    public UpdatedGroupBuilder() {
    } 
    
    public UpdatedGroupBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.Group arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>> E getAugmentation(Class<E> augmentationType) {
    ...
    public UpdatedGroupBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public UpdatedGroupBuilder setBuckets(Buckets value) {
    
        this._buckets = value;
        return this;
    }
    
    public UpdatedGroupBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public UpdatedGroupBuilder setGroupId(GroupId value) {
    
        this._groupId = value;
        return this;
    }
    
    public UpdatedGroupBuilder setGroupName(String value) {
    
        this._groupName = value;
        return this;
    }
    
    public UpdatedGroupBuilder setGroupType(GroupTypes value) {
    
        this._groupType = value;
        return this;
    }
    
    public UpdatedGroupBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public UpdatedGroup build() {
        return new UpdatedGroupImpl(this);
    }

    private static final class UpdatedGroupImpl implements UpdatedGroup {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>> augmentation;

        private UpdatedGroupImpl(UpdatedGroupBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.group.update.UpdatedGroup>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            UpdatedGroupImpl other = (UpdatedGroupImpl) obj;
            if (_barrier == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("UpdatedGroup [");
            boolean first = true;
