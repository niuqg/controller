...
public class QueueOpErrorNotificationBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>> augmentation = new HashMap<>();

    public QueueOpErrorNotificationBuilder() {
    } 
    
    public QueueOpErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.errors.rev131116.ErrorMessage arg) {
        this._code = arg.getCode();
        this._data = arg.getData();
        this._type = arg.getType();
    }
    
    public QueueOpErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeErrorReference arg) {
        this._objectReference = arg.getObjectReference();
    }
    
    public QueueOpErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
        this._transactionId = arg.getTransactionId();
    }
    
    public QueueOpErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.BaseNodeErrorNotification arg) {
        this._node = arg.getNode();
    }
    
    public QueueOpErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>> E getAugmentation(Class<E> augmentationType) {
    ...
    public QueueOpErrorNotificationBuilder setCode(Integer value) {
        if (value != null) {
    ...
    public QueueOpErrorNotificationBuilder setData(String value) {
    
        this._data = value;
        return this;
    }
    
    public QueueOpErrorNotificationBuilder setType(ErrorType value) {
    
        this._type = value;
        return this;
    }
    
    public QueueOpErrorNotificationBuilder setObjectReference(ObjectReference value) {
    
        this._objectReference = value;
        return this;
    }
    
    public QueueOpErrorNotificationBuilder setTransactionId(TransactionId value) {
    
        this._transactionId = value;
        return this;
    }
    
    public QueueOpErrorNotificationBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public QueueOpErrorNotificationBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public QueueOpErrorNotificationBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public QueueOpErrorNotification build() {
        return new QueueOpErrorNotificationImpl(this);
    }

    private static final class QueueOpErrorNotificationImpl implements QueueOpErrorNotification {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>> augmentation;

        private QueueOpErrorNotificationImpl(QueueOpErrorNotificationBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.QueueOpErrorNotification>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            QueueOpErrorNotificationImpl other = (QueueOpErrorNotificationImpl) obj;
            if (_code == null) {
                if (other._code != null) {
                    return false;
                }
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("QueueOpErrorNotification [");
            boolean first = true;
