...
public class RoleRequestErrorNotificationBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>> augmentation = new HashMap<>();

    public RoleRequestErrorNotificationBuilder() {
    } 
    
    public RoleRequestErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.errors.rev131116.ErrorMessage arg) {
        this._code = arg.getCode();
        this._data = arg.getData();
        this._type = arg.getType();
    }
    
    public RoleRequestErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeErrorReference arg) {
        this._objectReference = arg.getObjectReference();
    }
    
    public RoleRequestErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
        this._transactionId = arg.getTransactionId();
    }
    
    public RoleRequestErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.BaseNodeErrorNotification arg) {
        this._node = arg.getNode();
    }
    
    public RoleRequestErrorNotificationBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>> E getAugmentation(Class<E> augmentationType) {
    ...
    public RoleRequestErrorNotificationBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification> augmentation) {
    ...
    private static final class RoleRequestErrorNotificationImpl implements RoleRequestErrorNotification {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>> augmentation;

        private RoleRequestErrorNotificationImpl(RoleRequestErrorNotificationBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.node.error.service.rev140410.RoleRequestErrorNotification>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            RoleRequestErrorNotificationImpl other = (RoleRequestErrorNotificationImpl) obj;
            if (_code == null) {
                if (other._code != null) {
                    return false;
                }
