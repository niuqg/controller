...
public class GroupAddedBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>> augmentation = new HashMap<>();

    public GroupAddedBuilder() {
    } 
    
    
    public GroupAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.Group arg) {
    ...
    public GroupAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
        this._node = arg.getNode();
    }
    
    public GroupAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionAware arg) {
        this._transactionId = arg.getTransactionId();
    }
    
    public GroupAddedBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>> E getAugmentation(Class<E> augmentationType) {
    ...
    public GroupAddedBuilder setGroupRef(GroupRef value) {
    
        this._groupRef = value;
        return this;
    }
    
    public GroupAddedBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public GroupAddedBuilder setBuckets(Buckets value) {
    
        this._buckets = value;
        return this;
    }
    
    public GroupAddedBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public GroupAddedBuilder setGroupId(GroupId value) {
    
        this._groupId = value;
        return this;
    }
    
    public GroupAddedBuilder setGroupName(String value) {
    
        this._groupName = value;
        return this;
    }
    
    public GroupAddedBuilder setGroupType(GroupTypes value) {
    
        this._groupType = value;
        return this;
    }
    
    public GroupAddedBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public GroupAddedBuilder setTransactionId(TransactionId value) {
    
        this._transactionId = value;
        return this;
    }
    
    public GroupAddedBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public GroupAddedBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public GroupAdded build() {
        return new GroupAddedImpl(this);
    }

    private static final class GroupAddedImpl implements GroupAdded {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>> augmentation;

        private GroupAddedImpl(GroupAddedBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.group.service.rev130918.GroupAdded>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            GroupAddedImpl other = (GroupAddedImpl) obj;
            if (_groupRef == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("GroupAdded [");
            boolean first = true;
