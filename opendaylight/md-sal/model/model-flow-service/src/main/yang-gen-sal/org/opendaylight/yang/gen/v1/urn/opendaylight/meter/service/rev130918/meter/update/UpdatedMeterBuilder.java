...
public class UpdatedMeterBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>> augmentation = new HashMap<>();

    public UpdatedMeterBuilder() {
    } 
    
    public UpdatedMeterBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.meter.types.rev130918.Meter arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>> E getAugmentation(Class<E> augmentationType) {
    ...
    public UpdatedMeterBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public UpdatedMeterBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public UpdatedMeterBuilder setFlags(MeterFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public UpdatedMeterBuilder setMeterBandHeaders(MeterBandHeaders value) {
    
        this._meterBandHeaders = value;
        return this;
    }
    
    public UpdatedMeterBuilder setMeterId(MeterId value) {
    
        this._meterId = value;
        return this;
    }
    
    public UpdatedMeterBuilder setMeterName(String value) {
    
        this._meterName = value;
        return this;
    }
    
    public UpdatedMeterBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public UpdatedMeter build() {
        return new UpdatedMeterImpl(this);
    }

    private static final class UpdatedMeterImpl implements UpdatedMeter {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>> augmentation;

        private UpdatedMeterImpl(UpdatedMeterBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.meter.service.rev130918.meter.update.UpdatedMeter>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            UpdatedMeterImpl other = (UpdatedMeterImpl) obj;
            if (_barrier == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("UpdatedMeter [");
            boolean first = true;
