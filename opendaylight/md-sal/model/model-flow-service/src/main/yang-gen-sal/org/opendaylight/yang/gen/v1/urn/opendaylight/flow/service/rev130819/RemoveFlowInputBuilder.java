...
public class RemoveFlowInputBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>> augmentation = new HashMap<>();

    public RemoveFlowInputBuilder() {
    } 
    
    public RemoveFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.NodeFlow arg) {
    ...
    public RemoveFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.Flow arg) {
        this._barrier = arg.isBarrier();
        this._bufferId = arg.getBufferId();
        this._containerName = arg.getContainerName();
        this._cookieMask = arg.getCookieMask();
    ...
    public RemoveFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.GenericFlowAttributes arg) {
        this._cookie = arg.getCookie();
        this._hardTimeout = arg.getHardTimeout();
        this._idleTimeout = arg.getIdleTimeout();
        this._priority = arg.getPriority();
    ...
    public RemoveFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.NodeContextRef arg) {
        this._node = arg.getNode();
    }
    
    public RemoveFlowInputBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.transaction.rev131103.TransactionMetadata arg) {
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>> E getAugmentation(Class<E> augmentationType) {
    ...
    public RemoveFlowInputBuilder setFlowRef(FlowRef value) {
    
        this._flowRef = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setFlowTable(FlowTableRef value) {
    
        this._flowTable = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setBarrier(Boolean value) {
    
        this._barrier = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setBufferId(Long value) {
        if (value != null) {
    ...
    public RemoveFlowInputBuilder setContainerName(String value) {
    
        this._containerName = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setCookieMask(FlowCookie value) {
    
        this._cookieMask = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setFlags(FlowModFlags value) {
    
        this._flags = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setFlowName(String value) {
    
        this._flowName = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setInstallHw(Boolean value) {
    
        this._installHw = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setInstructions(Instructions value) {
    
        this._instructions = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setMatch(Match value) {
    
        this._match = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setOutGroup(Long value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Long>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Long("0"), new Long("4294967295")));
    ...
    public RemoveFlowInputBuilder setOutPort(BigInteger value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public RemoveFlowInputBuilder setStrict(Boolean value) {
    
        this._strict = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setCookie(FlowCookie value) {
    
        this._cookie = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setHardTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public RemoveFlowInputBuilder setIdleTimeout(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public RemoveFlowInputBuilder setPriority(Integer value) {
        if (value != null) {
            boolean isValidRange = false;
            List<Range<Integer>> rangeConstraints = new ArrayList<>(); 
            rangeConstraints.add(Range.closed(new Integer("0"), new Integer("65535")));
    ...
    public RemoveFlowInputBuilder setTableId(Short value) {
        if (value != null) {
            boolean isValidRange = false;
    ...
    public RemoveFlowInputBuilder setNode(NodeRef value) {
    
        this._node = value;
        return this;
    }
    
    public RemoveFlowInputBuilder setTransactionUri(Uri value) {
    
        this._transactionUri = value;
        return this;
    }
    
    public RemoveFlowInputBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public RemoveFlowInput build() {
        return new RemoveFlowInputImpl(this);
    }

    private static final class RemoveFlowInputImpl implements RemoveFlowInput {

        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput.class;
        }
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>> augmentation;

        private RemoveFlowInputImpl(RemoveFlowInputBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.service.rev130819.RemoveFlowInput>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            RemoveFlowInputImpl other = (RemoveFlowInputImpl) obj;
            if (_flowRef == null) {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder("RemoveFlowInput [");
            boolean first = true;
