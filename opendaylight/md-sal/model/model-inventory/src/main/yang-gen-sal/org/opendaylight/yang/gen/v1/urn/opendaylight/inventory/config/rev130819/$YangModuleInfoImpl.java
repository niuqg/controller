...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-inventory-config";
    private final String namespace = "urn:opendaylight:inventory:config";
    private final String revision = "2013-08-19";
    private final String resourcePath = "/META-INF/yang/opendaylight-inventory-config.yang";
