...
public class NodeBuilder {
    ...
    private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>> augmentation = new HashMap<>();
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>> E getAugmentation(Class<E> augmentationType) {
    ...
    public NodeBuilder addAugmentation(Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node> augmentation) {
    ...
    private static final class NodeImpl implements Node {
        ...
        public Class<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node> getImplementedInterface() {
        ...
        private final Map<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>> augmentation;
        ...
        private NodeImpl(NodeBuilder builder) {
            ...
            switch (builder.augmentation.size()) {
             case 0:
                 ...
                 break;
             case 1:
                 final Map.Entry<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>> e = builder.augmentation.entrySet().iterator().next();
                 this.augmentation = Collections.<Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node>>singletonMap(e.getKey(), e.getValue());
                 break;
             default :
