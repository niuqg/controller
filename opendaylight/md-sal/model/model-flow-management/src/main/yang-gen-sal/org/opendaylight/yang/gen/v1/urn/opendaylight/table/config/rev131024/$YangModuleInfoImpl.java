...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "table-management";
    private final String namespace = "urn:opendaylight:table:config";
    private final String revision = "2013-10-24";
    private final String resourcePath = "/META-INF/yang/table-management.yang";
