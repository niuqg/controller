...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "meter-management";
    private final String namespace = "urn:opendaylight:meter:config";
    private final String revision = "2013-10-24";
    private final String resourcePath = "/META-INF/yang/meter-management.yang";
