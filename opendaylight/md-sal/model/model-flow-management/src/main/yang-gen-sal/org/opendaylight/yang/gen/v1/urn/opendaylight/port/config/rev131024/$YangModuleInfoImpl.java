...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "port-management";
    private final String namespace = "urn:opendaylight:port:config";
    private final String revision = "2013-10-24";
    private final String resourcePath = "/META-INF/yang/port-management.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.$YangModuleInfoImpl.getInstance());
