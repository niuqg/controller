...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "group-management";
    private final String namespace = "urn:opendaylight:group:config";
    private final String revision = "2013-10-24";
    private final String resourcePath = "/META-INF/yang/group-management.yang";
