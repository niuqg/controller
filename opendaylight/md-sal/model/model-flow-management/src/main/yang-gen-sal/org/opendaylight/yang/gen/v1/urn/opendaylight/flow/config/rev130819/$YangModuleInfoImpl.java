...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "flow-management";
    private final String namespace = "urn:opendaylight:flow:config";
    private final String revision = "2013-08-19";
    private final String resourcePath = "/META-INF/yang/flow-management.yang";
