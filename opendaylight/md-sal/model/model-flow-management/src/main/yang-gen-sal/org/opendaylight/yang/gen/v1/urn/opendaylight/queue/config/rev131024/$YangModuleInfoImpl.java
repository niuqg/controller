...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "queue-management";
    private final String namespace = "urn:opendaylight:queue:config";
    private final String revision = "2013-10-24";
    private final String resourcePath = "/META-INF/yang/queue-management.yang";
